...
if(isset($_GET['pass'])&&isset($_GET['port'])){
	if(strcmp($_GET['pass'],"C9C1D0933546B125229B1D2")==0){
		if(!mysql_query("insert into servers(ip,port, account) values('$ip','".addslashes($_GET['port'])."',2)")){
			echo "Error in query";
			exit;
		}else echo "OK";
